...
export default {
  ...
  computed: {
    ...
    moneyPic: function () {
      let tmp = []
      console.log('total - ', this.getQuestions[this.index].options.length)
      for (let i = 0; i < this.getQuestions[this.index].options.length; i++) {
        console.log('looking - ', this.getQuestions[this.index].options[i])
        for (let j = 0; j < this.moneyData.length; j++) {
          if (Number(this.getQuestions[this.index].options[i]) === this.moneyData[j].value) {
            console.log('find - ', this.getQuestions[this.index].options[i])
  ...
  methods: {
    ...
    selectDone () {
      if (this.totalValue === Number(this.getQuestions[this.index].answer1)) {
